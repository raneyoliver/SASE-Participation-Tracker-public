...
@javascript
@authRequired
Scenario: Sign-in form link is inaccessible when outside of its time restriction
  When I go to the homepage to view the form link
  Then I log in
  Then I go to the event list
  Then I click the all events filter
  ...
  Then the form id links to the form page
  Then I click the link
  Then I am redirected to the form unavailable page

@restrictedRSVPFormRequired
@javascript
@authRequired
Scenario: RSVP form link is inaccessible when outside of its time restriction
  When I go to the homepage to view the form link
  Then I log in
  Then I go to the event list
  Then I click the all events filter
