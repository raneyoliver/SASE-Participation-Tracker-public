...
@javascript
Scenario: Event cards are sorted by id by default
  When I go to the homepage
  Then events should be sorted by id

@javascript
Scenario: Event cards are sorted chronologically after clicking sort by date
  When I go to the homepage
  Then I click sort by date
  Then events should be sorted chronologically

@javascript
Scenario: Event cards are sorted reverse-chronologically after clicking sort by date twice
  When I go to the homepage
  Then I click sort by date
  Then I click sort by date
